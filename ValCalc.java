...
public class ValCalc {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("What battlepass level are you on?");
        lvl = scanner.nextInt();
        System.out.println("Do you have the premium battlepass track? (y/n)");
    ...
    public static Integer calcLvlXp() {
        ...
        Integer x = 1250;
        Integer y = null;
        //calculates how much xp your level needs to be completed
        for (int i=1; i<=lvl; i++) {
            x = x + 750;
            y = x;
        }
